...
export default function Placements() {
  ...
  useEffect(() => {
    fetch(
      "https://clist.by/api/v2/contest/?username=minor-project&api_key=76c4a281d8c5636fb8dab0cdd36d6c88c85fb213&limit=1200&offset=500&format_time=true"
      // {
      //   headers: {
      ...
      <div className="wrapper">
            ...
            <div className="job-cards">
              ...
              <div className="job-card">
                <div className="job-card-header">
                  <img src="https://clist.by//imagefit/static_resize/64x64/img/resources/spoj_com.ico" alt="img"/>
                  {/* <!-- dots --> */}
                  <div className="menu-dot"></div>
                </div>

                <div className="job-card-title">Contest Name</div>
                <div className="job-card-title">Host</div>
                <div className="job-card-title">Start: </div>
                <div className="job-card-title">End: </div>


                {/* <!-- tags --> */}
                <div className="job-detail-buttons">
                  <button className="search-buttons detail-button">Hackathon</button>
                  <button className="search-buttons detail-button">48 hours</button>
                  <button className="search-buttons detail-button">Beginner</button>
                </div>
                {/* <!-- buttons --> */}
                <div className="job-card-buttons">
                  <button className="search-buttons card-buttons">Register</button>
                  <button className="search-buttons card-buttons-msg">Visit Site</button>
                </div>
              </div>
        ...
        <path d="M512 92L383.7 0 256 91.5v1l127.7 91.6zm0 0M512 276.4l-128.3-92L256 275.9v1l127.7 91.5zm0 0M256 486.1l128.4-92-128.3-92zm0 0" fill="#feb0a5" />
                ...
                <div className="job-card-subtitle">
                  Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam rem sapiente repudiandae ut dolorem eius aliquam quia possimus asperiores nam.
                </div>
                ...
                {/* <!-- buttons --> */}
                <div className="job-card-buttons">
                  <button className="search-buttons card-buttons">Read More</button>
