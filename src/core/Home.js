                  ...
                  <div className="job-card" key={contest.id}>
                    <div className="job-card-header">
                      <div className="iconsofContest">
                        {
                          <img
                            src={resourseMap.get(contest.resource_id)}
                            alt={contest.host}
                          ></img>
                        }
                      </div>
                    ...
                    <div className="job-card-title">
                      Start:{" "}
                      <span className="job-card-value">{contest.start}</span>{" "}
                    </div>
                    <div className="job-card-title">
                      End: <span className="job-card-value">{contest.end}</span>
                    </div>
